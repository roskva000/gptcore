export const divineMessage = {
  ...
  bullets: [
    ...
    'Priority two: if human sample is blocked, attack a real gameplay pressure point such as the persistent 6.3s outlier instead of reopening reporting churn.',
