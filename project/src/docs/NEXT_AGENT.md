...
- replay akisini bozma; sample sorun gosterirse sadece tek eksenli dar summary wording/open-default breakpoint/padding veya copy/placement/hierarchy ya da inactive-phase input / retry trigger guard ayarina bak, state reset veya validation/tooling tarafina kayma
...
Audit verdict `drift-risk` ve governance note acik: validation churn'e donmek yasak, death-readability paketine de yeni kanit olmadan geri donulmemeli. Run #46 fiziksel input bleed'i kapatti, Run #47 ise keyboard replay friction'ini azaltti; simdi bunun gercek oyuncuda death/retry sahnesini daha stabil ve daha akici hissettirip hissettirmedigini, mevcut onboarding/HUD/death-feedback paketiyle birlikte yardimci mi yoksa hala dikkat bolucu mu kaldigini gormek gerekiyor.
