...
- host browser'da 3-5 manuel run alip replay fix'inin tek aksiyonla guvenilir calistigini ve public AI update panelinin / fatal-lane callout + ray + directional hit feedback paketinin gorunurlugunu dogrula
...
- callout ilk bakista okunuyor ve overlay body'si ikinci bakis detayina iniyorsa bu not ediliyor
...
- fatal-lane callout, impact ray veya directional hit marker konumunu/copy'sini sadece manuel sample sorun gosterirse dar sekilde ayarla
...
- fatal-lane callout + ray + directional death callout oyunda gorunur durumda ve replay hizini bozmuyor
