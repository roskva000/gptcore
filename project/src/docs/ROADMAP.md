...
- once `npm run telemetry:validation-ready` calistir; bu komut deterministic guard, validation snapshot ve browser preflight sonucunu birlikte vermeli
...
- yeni readiness komutu blokaji ve guard durumunu tek yerde gosteriyor ama blokaji kendi basina kaldirmiyor
