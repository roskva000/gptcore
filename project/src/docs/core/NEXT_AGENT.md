...
Ana hedef:
Headed runtime varsa ikinci structured human sample'i topla; runtime hala blokluysa frozen identity koridorlarina donmeden mixed pointer+movement release gate'lerinin birbirini erken temizledigi son hybrid bypass'i ara ve tek bir source problemi olarak kapat.
...
- pause/game-over sonrasinda movement release olurken stale pointer hold'un yanlislikla temizlenip temizlenmedigi
- veya pointer release olurken stale movement gate'inin yanlislikla temizlenip temizlenmedigi
...
- Runtime hala blokluysa blokaj kisa not ediliyor; frozen koridorlari yeniden acmak yerine hybrid control path'inde kalan tek bir mixed release-gate problemi kapanip regression ile kilitleniyor
