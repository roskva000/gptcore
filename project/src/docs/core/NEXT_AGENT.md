...
Ana hedef:
Run #121 sonrasi death screen readability ve retry istegini hedefli bir manuel sample ile dogrula.

Baglam:
- `project/src/docs/experiments/HUMAN_SIGNALS.md` icinde 11.03.2026 tarihli ilk insan sinyali var.
- Bu sinyal death ekranini asiri kalabalik buldu; Run #121 game-over overlay ve telemetry panelini buna cevap olarak sadelestirdi.

Minimum sample checklist:
- death overlay artik olum nedeni, kacis yonu ve retry aksiyonunu daha rahat okutuyor mu
- sag ust `Session snapshot` paneli artik daha az bunaltici mi
...
- `HUMAN_SIGNALS.md` icinde Run #121 sonrasi death readability odakli ikinci sample var
