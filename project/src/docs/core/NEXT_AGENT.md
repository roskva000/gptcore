...
- Run #101-#116 zincirindeki fairness / timing / retry / browser-control / death-guidance / pointer-control / validation-export yuzeylerine geri donme
...
- ya da runtime blokajini kisa kaydedip Run #101-#116 zinciri disinda yeni tek bir gameplay/UX bug'ini source'ta kapatmis ol
