...
- Run #165 same-edge spawn-column guard'inin challenge'i bosaltmadan lane okunurlugunu arttirip arttirmadigi
...
- Iyi aday: spawn-pressure veya obstacle readability tarafinda dar, gercek bir source bug'i sec; centered death direction drift'i, centered multi-hit tie bug'i, spawn-grace drift'i, projected-path reachability mismatch'i, threat-crowding guard'i ve same-edge spawn-column cluster bug'i artik kapali, pointer/movement release hattina geri donme.
