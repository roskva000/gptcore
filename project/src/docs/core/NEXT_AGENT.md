...
- Ya da runtime blokaji kisa not edilip near-miss, surge, wall-target lag veya exact-`10.0s` threshold fix'ine geri donmeden tek yeni gameplay/UX source problemi source + docs + `latestRun.ts` ile kapatildi
