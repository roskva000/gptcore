...
- Iyi aday: spawn-pressure veya obstacle visibility tarafinda dar, gercek bir source bug'i sec; projected-path reachability mismatch ve threat-crowding guard'i artik kapali, pointer/movement release hattina geri donme.
