...
- interactive runtime yine yoksa pause/resume/held-input mikro-fix zincirine, Run #87 `20s+` chase tuning'ine, Run #88-103 freeze/visible-arena fairness/death-callout/grace-cutoff/center-guidance/HUD/fresh-resume/pointer-start-steering/non-pointer-start-resume-guard/validation-export-count/completed-run-HUD/summary-log-count/edge-target-clamp/wall-pinned-velocity-clamp yuzeylerine bir tur daha donme; yeni ve dar bir gameplay problemi sec
