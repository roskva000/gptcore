...
- Freeze: WebKit audio fallback, touch gesture lock, bu yeni death snapshot surface'i, `strafe`, `lead`, surge, echo, drift, opener cutoff, spawn-grace, near-miss, `10s`/`60s` payoff, HUD/panel/pause/replay-HUD koridorlarina yeni bug veya yeni sample olmadan geri donme.
...
Ana hedef:
Touch-capable headed browser'da ikinci structured human sample'i topla ve yeni death snapshot yuzeyinin gercek oyuncuda daha okunur, daha etkileyici ve daha retry-tetikleyici hissedip hissettirmedigini dogrula.
...
- Sample death snapshot yuzeyi icin keep / tune / revert karari birakiyor
