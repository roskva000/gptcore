...
- Run #101-#106 zincirindeki input/pause/fairness/timing/validation yuzeylerine geri donme
- telemetry wording, latest-run copy veya docs ritual churn'u acma
- tek bir yeni gameplay/UX bug'i sec; obstacle reuse/cull veya baska dar source kusuru gibi yeni bir yuzey olsun
