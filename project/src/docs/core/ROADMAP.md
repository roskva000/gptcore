...
- headed runtime yoksa telemetry/copy veya ayni opening-fairness paketini buyutmeden tek bir dar gameplay/UX bug'ini kapat; Run #95 focus-loss movement resume, Run #97 pointer start/retry steering kilidi, Run #98-100 validation/export/HUD/log counting semantigi, Run #101 edge-target clamp, Run #102 wall-pinned velocity clamp, Run #103 non-pointer start/resume steering guard'i ve Run #104 canli run-time timing butunlugu kapandi, bu yuzeylere hemen geri donmeden yeni fallback adayi secilmelidir
...
- manual sample gelmezse validation/export/HUD/log counting, opening fairness, Run #101 edge-target clamp, Run #102 wall-pinned velocity clamp, Run #103 non-pointer start/resume steering guard'i veya Run #104 canli run-time timing yuzeyine geri donme; `20s+` chase'i tekrar acmadan freeze/cull, obstacle reuse veya baska tek bir dar source bug'i sec
