...
- validation export sample boyutu artik tamamlanmis run sayisina hizali; bu yuzeyi yeniden acmadan ilerle
...
- validation export yarim kalmis/aktif start'lar olsa bile sample boyutunu tamamlanmis run sayisiyla raporluyor
...
- manual sample gelmezse validation/export counting yuzeyine de geri donme; `20s+` chase'i tekrar acmadan freeze/cull, obstacle reuse, compact telemetry/support-strip, focus-loss/input, pointer start/retry steering, center-overlap death guidance ve visible-arena fairness disinda tek bir dar source bug'i sec
