...
- manual sample gelmezse validation/export/HUD/log counting, opening fairness, Run #101 edge-target clamp veya Run #102 wall-pinned velocity clamp yuzeyine geri donme; `20s+` chase'i tekrar acmadan freeze/cull, obstacle reuse veya baska tek bir dar source bug'i sec
